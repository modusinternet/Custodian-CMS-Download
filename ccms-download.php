...
<? else: ?>
		...
		<div class="tabs">
			...
			<button class="tab" id="tab04Title" onclick="openTab(event,'tab04Content')"></button>
			<button class="tab" onclick="openTab(event,'tab05Content')" style="padding:12px 5px 7px 5px;right: 18px;position:absolute">
